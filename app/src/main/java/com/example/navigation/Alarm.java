...
public class Alarm {
    public void accident() throws IOException {
        StringBuilder urlBuilder = new StringBuilder("http://www.utic.go.kr/guide/imsOpenData.do?key="); /*URL*/
        urlBuilder.append("?" + URLEncoder.encode("ServiceKey","UTF-8") + "=klJXl3fne6niJzEYZ3YC3MenAHxXJBvZaWQElXlDZKTI5HaNd8ZMWb9vv0XIsTQ"); /*Service Key*/
